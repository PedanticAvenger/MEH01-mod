...
+ Created a version of the encoder knob part that allows for insertion of a 1/16" piece of hex key shaft (bloody imperial units.....) in place of the printed plastic piece.  I didn't have any problems with the printed version but again, I travel with my kbd and the risk of forces perpendicular to the axis of the encoder breaking it bothered me.  This change can be filed under individual paranoia if desired or used if you like the idea.  I got a set of 1/16" hex wrenches from Amazon/Ali and just cut them off and clean them up with either a file or a dremel cutoff wheel.  They were a good press fit into the knob.  Length of the hex piece is ~9mm.
